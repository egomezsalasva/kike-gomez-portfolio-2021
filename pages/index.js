...
//MAIN COMPONENT
  export default function Home() {
    ...
    //TODO WORK LIST MOTION

    //TODO WORK LIST ITEM COMPONENT

    //TODO ON REFRESH TOP TO THE PAGE

    //TODO TOGGLE COLOR THEME

    //TODO CHROME BOTTOM BAR PINNING BEHAVIOUR
      ...
      useEffect( () => {
        ...
        //Intro Timeline Desk
          introTl
                ...
                .to(introBottomBlockRef, {duration:2, yPercent: 100, ease: "power2.inOut"}, "stage02")
                ...
                //Top Fold Mobile
                .from(nameMobileRef, {duration:2, y: "-16rem", alpha: 0, rotate: 5.625, ease: "power2.inOut"}, "stage04-=2")
    ...
    return (
      <>
        ...
        <Preloader
          ...
          introTopLoadingBarRefProp={el => {introTopLoadingBarRef = el}}
          introBottomBlockRefProp={el => {introBottomBlockRef = el}}
          introBottomLoadingBarRefProp={el => {introBottomLoadingBarRef = el}}
        />
        ...
        <Container>
          ...
          <TopFold 
            nameRefProp={el => {nameRef = el}}
            descriptionRefProp={el => {descriptionRef = el}}
            surnameRefProp={el => {surnameRef = el}}
            nameMobileRefProp={el => {nameMobileRef = el}}
            descriptionMobileRefProp={el => {descriptionMobileRef = el}}
            surnameMobileRefProp={el => {surnameMobileRef = el}}
          />
