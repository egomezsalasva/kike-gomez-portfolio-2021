    ...
    <>
      <DesktopContent>
        ...
        <div className="workListContainer" id="workList">
          ...
          <div className="workProject">
            <a
              href="https://www.ajuarestudio.com"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <div className="workProject">
            <a
              href="https://www.behance.net/gallery/78665785/Aaron-Dormer-Film-Director-Website"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <div className="workProject">
            <a
              href="https://axelbalazsi.netlify.app/"
              target="_blank"
              rel="noreferrer"
            >
